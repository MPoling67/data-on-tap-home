    ...
    <div className="no-print" style={{ background: "#242422", padding: "2rem clamp(16px,4vw,2rem)" }}>
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
        <div style={{ marginBottom: "1.25rem" }}>
          ...
          <p style={{ fontSize: 13, fontWeight: 300, color: "#c8c4bc", lineHeight: 1.6, margin: 0, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Subscribe to get weekly ideas on how to use AI to organize, share, and monetize your expertise.</p>
        </div>
        {!submitted ? (
          <>
